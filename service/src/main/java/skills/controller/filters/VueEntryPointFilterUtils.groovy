...
class VueEntryPointFilterUtils {
    private final List<String> backendResources =
            Collections.unmodifiableList("/api,/admin/,/app,/static,/clientDisplay,/favicon.ico,/skilltree.ico,/icons,/performLogin,/createAccount,/createRootAccount,/grantFirstRoot,/userExists,/oauth,/login,/logout,/root,/supervisor,/public,/skills-websocket,/resetPassword,/performPasswordReset,/metrics/global,/saml2".split(",").toList())
